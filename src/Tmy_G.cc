...
int Tmy_G::max(Tmy_double rho, T_alpha_container alpha, T_grad_container grad, Tmy_kernel *kernel, callback_type2 f)
{
  Tmy_double gmax = -HUGE_VAL;
  int idx_max = -1;
...
int Tmy_G::max(int idx_b, Tmy_double rho, T_alpha_container alpha, T_grad_container grad, Tmy_kernel *kernel, callback_type2 f)
{
  Tmy_double gmax = -HUGE_VAL;
  int idx_max = -1;
...
int Tmy_G::max(int idx_b, Tmy_double rho, T_alpha_container alpha, T_grad_container grad, Tmy_kernel *kernel, Tmy_alpha *my_alpha, callback_type3 f)
{
  Tmy_double gmax = -HUGE_VAL;
  int idx_max = -1;
...
int Tmy_G::cari(int idx_b, Tmy_double rho, T_alpha_container alpha, T_grad_container grad, Tmy_kernel *kernel, Tmy_alpha *my_alpha, callback_type3 f)
{
  // cout << " Cari 1 " << endl;
  int idx_a = -1;
